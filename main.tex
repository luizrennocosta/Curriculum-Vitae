...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{References}
            \cvref{Ref 1}{Felipe de Albuquerque}
            \divider
            
            \cvref{Ref 2}{Arthur Lemos}
            \divider
        % ----- REFERENCES -----
        ...
        \cvachievement{\faHeartbeat}{Completed \textit{Deep Learning} Specialization on Coursera}{The courses included:
        \begin{itemize}
        ...
        \cvsection{Experience}
            \cvevent{Data Engineer }{| Dextra Consulting}{12/2020 -- Present}{Remote}
            \begin{itemize}
        ...
        % ----- PROJECTS -----
        \cvsection{Projects}
            \cvevent{Anime Opening Rate (WIP)}{}{01/2021 -- Present}{}
            \begin{itemize}
